...
roll_pid_corr=0; roll_max = 2; roll_min = -2

roll_kp = 0.2   #0.2 - 0.3
roll_ki = 0.01     #0.001 #0.000001 #0.00001# somewhere around 0.002
...
pitch_pid_corr = 0; pitch_max = 2; pitch_min = -2

pitch_kp = 0.2      #0.08#0.1
pitch_ki = 0.01#       0.001 #0.000001
pitch_kd = 0        #1#11
